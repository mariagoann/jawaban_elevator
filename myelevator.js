...
Elevator.prototype.decide = function() {
    ...
    return this.commit_decision(Math.floor(num_floors / 1)); 
    /*
        jumlah lantai dibagi 1 : 30
        maka elevator untuk pemberangkatan 1 akan berjalan 4 sekaligus
        untuk selanjutnya akan di random oleh simulator
    */
};
